...
function makeGatewayExecutableSchema(_a) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var schema, _b, documentSchema, subgraphSchema;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, loadSchema_1.readSchemaFile)(schemaPath)];
                case 1:
                    _b = _c.sent();
                    return [3 /*break*/, 3];
                case 2:
                ...
                case 3:
                    schema = _b;
                    documentSchema = (0, graphql_tag_1.gql)(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n    ", "\n  "], ["\n    ", "\n  "])), schema);
                    subgraphSchema = (0, subgraph_1.buildSubgraphSchema)([
                        {
